 ...
 */
package com.pramid.ml.ml.bayesian;
...
public class BayesianSpam {
	...
	public double probabilitySpam(String m) {
		...
		for (String word : words) {
			...
			event.getTable()
					.addLine(this.spamBag.probability(word), true, true); // spam
			event.getTable()
					.addLine(this.hamBag.probability(word), true, false); // ham
	...
	public void test(String message) {
		...
		System.out.println("Probability of \"" + message + "\" being spam is "
				+ Format.formatPercent(d));
	}
