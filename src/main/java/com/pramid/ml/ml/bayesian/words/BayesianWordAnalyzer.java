...
public class BayesianWordAnalyzer {
	...
	public BayesianWordAnalyzer(int theK, String theClassName,
			String[] classStrings, String theNotClassName,
	...
	public double probability(String m) {
		...
		for (String word : words) {
			...
			event.getTable().addLine(this.classBag.probability(word), true,
					true); // spam
			event.getTable().addLine(this.notClassBag.probability(word), true,
					false); // ham
