 ...
 */
package com.pramid.ml.ml.bayesian.words;
...
public class BayesianSpam {
	...
	public static void test(BayesianWordAnalyzer a, String message) {
		...
		System.out.println("Probability of \"" + message + "\" being "
				+ a.getClassName() + " is " + Format.formatPercent(d) + " ; "
				+ a.getLastProblem());
	}
	...
	public static void testWordClass(BayesianWordAnalyzer a, String word) {
		...
		System.out
				.println(a.getLastProblem() + " = " + Format.formatPercent(d));
	}
	...
	public static final void main(String[] args) {
		BayesianWordAnalyzer a1 = new BayesianWordAnalyzer(0, "spam",
				SPAM_DATA, "ham", HAM_DATA);
		System.out.println("Using Laplace of 0");
		System.out.println("P(" + a1.getClassName() + "): "
				+ Format.formatPercent(a1.getClassProbability()));
		System.out.println("P(" + a1.getNotClassName() + "): "
				+ Format.formatPercent(a1.getNotClassProbability()));
		...
		BayesianWordAnalyzer a2 = new BayesianWordAnalyzer(1, "spam",
				SPAM_DATA, "ham", HAM_DATA);
		System.out.println("Using Laplace of 1");
		System.out.println("P(" + a2.getClassName() + "): "
				+ Format.formatPercent(a2.getClassProbability()));
		System.out.println("P(" + a2.getNotClassName() + "): "
				+ Format.formatPercent(a2.getNotClassProbability()));
