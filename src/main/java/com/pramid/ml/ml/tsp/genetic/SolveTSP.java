 ...
 */
package com.pramid.ml.ml.tsp.genetic;
...
import com.pramid.ml.ml.tsp.City;

/**
 * SolveTSP with a genetic algorithm. The Encog API includes a generic genetic
 * algorithm problem solver. This example shows how to use it to find a solution
 * to the Traveling Salesman Problem (TSP). This example does not use any sort
 * of neural network.
 * 
 * @author
 *
