...
/**
 * This class is a very simple example of a HMM for a discrete input. First, a
 * known HMM is created and output is generated from it. We then create a second
 * initial HMM, and use the data generated from the first HMM to train it to
 * match the first.
 */
public class HMMSimpleDiscrete {
	...
	public static void main(String[] args) {
		...
		System.out
				.println("Training Discrete Hidden Markov Model with Baum Welch");
