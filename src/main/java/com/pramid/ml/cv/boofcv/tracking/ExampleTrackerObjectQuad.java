...
public class ExampleTrackerObjectQuad {
	...
	public static void main(String[] args) {
		...
		TrackerObjectQuad tracker = FactoryTrackerObjectQuad.circulant(null,
				GrayU8.class);
		...
		// ConfigComaniciu2003(), ImageType.pl(3, GrayU8.class));
		// FactoryTrackerObjectQuad.meanShiftComaniciu2003(new
		// ConfigComaniciu2003(true),ImageType.pl(3,GrayU8.class));
		...
		// MeanShiftLikelihoodType.HISTOGRAM,ImageType.pl(3,GrayU8.class));
		...
		// frame
		Quadrilateral_F64 location = new Quadrilateral_F64(211.0, 162.0, 326.0,
				153.0, 335.0, 258.0, 215.0, 249.0);
